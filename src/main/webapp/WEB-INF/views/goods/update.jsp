...
<div class="pageContent" id="goods_edit">
    <form method="post" action="/goods/update" class="pageForm required-validate"
        ...
        <div class="pageFormContent" layoutH="56">
            ...
            <p style="width: 100%;">
                ...
                <input name="defaultImg" class="required textInput valid" type="text" size="80"
                 value="${bean.defaultImg}" >
            </p>
            <div class="unit">
                <div class="post-btn" id="J-goods-edit-uploadImg">上传图片</div>
            </div>
            <p style="width: 100%;">
                <label>状态：</label>
            ...
            <div class="unit">
                ...
                <textarea class="editor" name="content" rows="30" cols="100" tools="simple" upImgUrl="/file/uploadImg"
                          upImgExt="jpg,jpeg,gif,png">${bean.content}</textarea>
            </div>
        </div>
        <div class="formBar">
            <ul>
...
<script type="text/javascript">
    $('#J-goods-edit-uploadImg').uploadify({
        ...
        onUploadSuccess: function (file, data, response) {
            ...
            $("#goods_edit input[name='defaultImg']").val(data.url);
        },
