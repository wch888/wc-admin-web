...
<div class="pageContent">
    ...
    <form method="post" id="flash_add_form" action="/flash/add" class="pageForm required-validate"
        ...
        <div class="pageFormContent" layoutH="56">
            <div class="pageFormContent" layoutH="56">
                ...
                <div class="unit">
                    <div id="flash_add-uploadImg">上传图片</div>
                </div>
                <div class="unit">
                    <label>类型：</label>
                    <select name="type">
                ...
                <div class="unit">
                    ...
                    <select name="status" id="">
                        ...
                        <option value="1" >置业顾问跟进中</option>
                        <option value="2" >交易成功</option>
                        <option value="-2" >交易失败</option>
                        <option value="-1" >线索无效</option>
                    </select>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $('#flash_add-uploadImg').uploadify({
        ...
        onUploadSuccess: function (file, data, response) {
            ...
            $("#flash_add_form input[name='imgUrl']").val(data.url);
            $("#flash_add_form").find("img").attr("src", data.url);
        },
