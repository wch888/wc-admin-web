...
<div class="pageContent">
    <form method="post" id="nav_update_form" action="/nav/update" class="pageForm required-validate"
        ...
        <div class="pageFormContent" layoutH="56">
            ...
            <div class="unit">
                <div id="nav_update-uploadImg">上传图片</div>
            </div>
            <div class="unit">
                <label>类型：</label>
                <select name="type">
...
<script type="text/javascript">
    $('#nav_update-uploadImg').uploadify({
        ...
        onUploadSuccess: function (file, data, response) {
            ...
            $("#nav_update_form input[name='imgUrl']").val(data.url);
            $("#nav_update_form").find("img").attr("src", data.url);
        },
