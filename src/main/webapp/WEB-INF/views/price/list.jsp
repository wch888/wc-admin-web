...
<form id="pagerForm" method="post" action="/price/list">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="/price/addView" target="navTab"><span>添加</span></a></li>
            <li><a class="edit" href="/price/updateView?id={id}" target="navTab"><span>编辑</span></a></li>
            <li><a class="delete" href="/price/del?id={id}" target="ajaxTodo"
