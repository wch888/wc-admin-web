package com.wc.web.controller.img;

import com.wc.common.util.BaseConfig;
import com.wc.web.thread.ImageSacleParam;
import com.wc.web.thread.ImageSacleThread;
import com.wc.web.until.DateUtil;
import com.wc.web.until.ImageUtil;
    ...
    public void uploadImg(MultipartHttpServletRequest request,
        ...
        try {
            ...
            if (fileMap != null && fileMap.size() > 0) {
                MultipartFile partFile = fileMap.get("filedata");
